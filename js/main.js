...
(function () {
  ...
  /* Start hero preload immediately */
  ...
  /* ---------------------------------------------------------
     5 · Landing → Animated Hero Transition
     --------------------------------------------------------- */
  ...
  function openInvitation() {
    ...
    /* Kick off music in the same user gesture */
    startAmbientAudio();
  ...
  /* ---------------------------------------------------------
     8 · Countdown  ·  31 Aug 2026, 11:30 IST
     --------------------------------------------------------- */
  (function countdown() {
    var target = new Date('2026-11-11T18:00:00+05:30').getTime();
